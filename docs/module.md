...
| <a name="input_cluster"></a> [cluster](#input\_cluster) | Cluster configuration with attributes<br/>      endpoint: "[Kubernetes endpoint address](https://www.talos.dev/v1.10/introduction/prodnotes/#decide-the-kubernetes-endpoint)"<br/>      name: "Name for cluster"<br/>      gateway: "Network gateway"<br/>      proxmox\_cluster: "An arbitrary name for the Talos cluster; **subject for deprecation** in a future version"<br/>      talos\_version: "[Talos version](https://github.com/siderolabs/talos/releases) with `v` prefix, e.g. `v1.2.3`; **subject for deprecation** in a future version" | <pre>object({<br/>    endpoint        = string<br/>    gateway         = string<br/>    name            = string<br/>    proxmox_cluster = string<br/>    talos_version   = string<br/>  })</pre> | n/a | yes |
