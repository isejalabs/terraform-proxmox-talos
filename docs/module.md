...
| <a name="input_talos_config_patches"></a> [talos\_config\_patches](#input\_talos\_config\_patches) | Paths to additional Talos Machine Configuration patches | <pre>list(<br/>    object({<br/>      path         = string<br/>      machine_type = optional(string, "all") # "all", "controlplane", "worker"<br/>    })<br/>  )</pre> | n/a | yes |
