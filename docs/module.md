...
| <a name="input_volumes"></a> [volumes](#input\_volumes) | n/a | <pre>map(<br/>    object({<br/>      node      = string<br/>      size      = string<br/>      datastore = optional(string, "local-zfs")<br/>      format    = optional(string, "raw")<br/>      vmid      = optional(number, 9999)<br/>    })<br/>  )</pre> | `{}` | no |
