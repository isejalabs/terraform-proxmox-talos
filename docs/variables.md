...
> **Note**: The `directory` and `partition` volume types are currently not implemented due to pending issues in the [siderolabs/terraform-provider-talos]() module. They are mentioned here for completeness and future reference.
