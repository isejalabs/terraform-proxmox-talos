...
- Added *optional* variable `cluster.api_server` to define kube apiserver
  options (cf. [Talos apiServerConfig](https://www.talos.dev/v1.11/kubernetes-guides/configuration/inlinemanifests/#extramanifests) documentation) (#91).
...
- Changing the `cluster.talos_machine_config_version` (former
  ...
  (#38, #90).
- Improved the way to install cilium with `inlineManifests` (#103).
